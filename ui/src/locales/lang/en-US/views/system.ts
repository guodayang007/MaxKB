export default {
  ...
  theme: {
    ...
    defaultTip: 'The default is the GTAI platform interface, supports custom settings',
    logoDefaultTip: 'The default is the GTAI login interface, supports custom settings',
